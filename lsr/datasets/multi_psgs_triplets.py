...
class MutiPSGsTripletsBatching:
    ...
    def __call__(self, batch):
        ...
        return {
            "queries": queries,
            "psgs": psgs,
            "psg_offset": torch.tensor(psg_offsets),
        }


class MultiPSGsTriplets(Dataset):
    def __init__(self, query_path, collection_path, triplet_path, num_psg=2):
        ...
        print(f"Number of triplets: {len(self.triplets)}")
